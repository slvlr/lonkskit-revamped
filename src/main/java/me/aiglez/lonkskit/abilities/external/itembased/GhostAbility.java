    ...
    public void whenRightClicked(PlayerInteractEvent e) {
        ...
        if (isItemStack(e.getPlayer().getInventory().getItemInMainHand())){
            if (!localPlayer.toBukkit().hasPotionEffect(PotionEffectType.INVISIBILITY)){
                ...
                localPlayer.toBukkit().addPotionEffect(new PotionEffect(PotionEffectType.INVISIBILITY,15 * 20,3,true,false));
                localPlayer.toBukkit().addPotionEffect(new PotionEffect(PotionEffectType.DAMAGE_RESISTANCE,15 * 20,2,true,false));
