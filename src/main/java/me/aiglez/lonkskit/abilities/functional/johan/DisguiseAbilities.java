...
public class DisguiseAbilities extends FunctionalAbility {
    ...
    private final List<Player> mooshrooms = Lists.newArrayList();
    private final List<Player> creepers = Lists.newArrayList();
    private final List<Player> spiders = Lists.newArrayList();
    private final List<Player> snowmen = Lists.newArrayList();
    private final List<Player> victimsOfSnow = Lists.newArrayList();
    private int times;
    private int times1;
    private int times2;
    ...
    public void registerListeners() {
        ...
        Events.subscribe(ProjectileHitEvent.class)
                ...
                .handler(e ->{
                    ...
                    applyEffects(LocalPlayer.get(victim));
                    victim.damage(3);
