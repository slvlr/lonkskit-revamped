...
public class CowboyAbility extends ItemStackAbility {
    ...
    public void registerListeners() {
        handleHorseListeners();
        handleLassoListeners();
    }

    private void handleLassoListeners() {

    }

    private void handleHorseListeners() {
        // spawn horse
        ...
        Events.subscribe(VehicleExitEvent.class)
                ...
                .handler(e -> {
                    ...
                    if(!localPlayer.toBukkit().isDead()) {
                        Schedulers.sync()
        ...
        Events.subscribe(EntityDeathEvent.class)
                ...
                .handler(e -> {
                    ...
                    if(localPlayer.toBukkit().isInsideVehicle()) {
                        localPlayer.toBukkit().getVehicle().remove();
